...
var l = function () {
  ...
  , n = function (a) {
    l.call(this);
    a.getElementsByTagName("CT_URL")
      .length && (this.b = a.getElementsByTagName("CT_URL")[0].textContent);
    a.getElementsByTagName("U")
      .length && (this.url = a.getElementsByTagName("U")[0].textContent);
    a.getElementsByTagName("T")
      .length && (this.title = a.getElementsByTagName("T")[0].textContent);
    a.getElementsByTagName("PREVIEW_IMG")
      .length && (this.c = a.getElementsByTagName("PREVIEW_IMG")[0].textContent);
    a.getElementsByTagName("S")
      .length && (this.d = a.getElementsByTagName("S")[0].textContent.replace(/<br>/g, ""))
  };
h(n, l);
var p = function (a) {
  m.call(this);
  if (a.firstChild && a.getElementsByTagName("GSP")
    .length) {
    if (a = a.getElementsByTagName("GSP")[0], a.getElementsByTagName("RES")
      .length) {
...
/*
 ...
 at https://chrome.google.com/extensions/intl/en/gallery_tos.html.
*/
var A = /(chrome|file|http?:\/\/chrome\.google\.com\/extensions)/
  ...
  , D = function (a, b) {
    0 == a.search(A) ? t(chrome.i18n.getMessage("sp_chrome_special_case_text")) :
      b ? "http://www.google.cn/" == b ? t(chrome.i18n.getMessage("sp_tld_special_case_text")) : b && y(b + "search?output=br&q=related:" + encodeURIComponent(a)) : s()
  };
